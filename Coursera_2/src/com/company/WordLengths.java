...
public class WordLengths {
    ...
    public void testCountWordLengths() {
        ...
        for (int i = 0; i < count.length; i++) {
            System.out.println("Length " + i + " = " + count[i] + " words");
        }
        System.out.println("Most common length = " + indexOfMax(count));
    ...
    private void countWordLengths(FileResource fr,int[] count) {
